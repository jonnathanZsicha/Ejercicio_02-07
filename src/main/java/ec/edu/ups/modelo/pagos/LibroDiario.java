...
public class LibroDiario implements Serializable{
    ...
    private List<ReciboDePago2> pagoMensualAlDocente;

    public LibroDiario() {
    }

    public LibroDiario(double montoTotal, List<PagoMensual> pagoMensualDeEstudiante, List<ReciboDePago2> pagoMensualAlDocente) {
    ...
    public List<ReciboDePago2> getPagoMensualAlDocente() {
        return pagoMensualAlDocente;
    }

    public void setPagoMensualAlDocente(List<ReciboDePago2> pagoMensualAlDocente) {
        this.pagoMensualAlDocente = pagoMensualAlDocente;
    }
